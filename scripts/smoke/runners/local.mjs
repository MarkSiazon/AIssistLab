...
import { getFreePort, waitForServerReady } from "../../lib/server-utils.mjs";
import {
...
} from "../assertions/dom-coverage.mjs";
import { trackBrowserIssues } from "../helpers/browser-issues.mjs";
import {
  buildMockChatStatusPayload,
  buildMockChatStreamBody,
} from "../mocks/chat.mjs";
import { buildMockClaudeCliStatusPayload } from "../mocks/claude.mjs";
import { assertRouteInteractionState } from "../assertions/interaction.mjs";
import { assertNoUnsafe } from "../assertions/privacy.mjs";
import {
  buildMockReleaseReadinessPayload,
  buildMockReleaseReadinessSection,
} from "../mocks/release.mjs";
import {
  fulfillAttachment,
  fulfillEventStream,
  fulfillJson,
} from "../helpers/route-fulfill.mjs";
import {
  installMockClipboard,
  readMockClipboardText,
} from "../helpers/browser-init.mjs";
import { buildMockIndexStatusPayload } from "../mocks/index.mjs";
import {
  buildMockRuntimeStatusPayload,
  buildMockSettingsEnvPayload,
} from "../mocks/settings.mjs";
import {
...
} from "../mocks/skills.mjs";
import { assertRouteSemanticState } from "../assertions/semantic.mjs";
import { createZip, extractZipEntries } from "../helpers/zip-utils.mjs";
import {
  startNextServer,
  stopChildProcess,
...
async function main() {
  ...
  const { child, logs } = startNextServer({
    root,
    mode: "dev",
    port,
    env: {
