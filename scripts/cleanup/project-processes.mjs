...
const PROJECT_COMMAND_PATTERNS = [
  ...
  /[\\/]scripts[\\/]smoke[\\/]runners[\\/]local\.mjs\b/i,
  /[\\/]scripts[\\/]smoke[\\/]runners[\\/]buttons\.mjs\b/i,
  /[\\/]scripts[\\/]smoke[\\/]runners[\\/]production\.mjs\b/i,
  /[\\/]scripts[\\/]release[\\/]verify\.mjs\b/i,
  /[\\/]scripts[\\/]release[\\/]prepare\.mjs\b/i,
  /[\\/]scripts[\\/]release[\\/]evidence\.mjs\b/i,
  /[\\/]scripts[\\/]test[\\/]run-tests\.mjs\b/i,
  /[\\/]scripts[\\/]qa[\\/]manual-external\.mjs\b/i,
];
