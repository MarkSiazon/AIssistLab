...
assert.equal(
  isProjectOwnedProcess(
    processInfo(
      12,
      1,
      "node C:/Repos/Skill Workshop/rag-interface/scripts/smoke/runners/local.mjs",
    ),
    repoRoot,
  ),
  true,
...
assert.equal(
  isProjectOwnedProcess(
    processInfo(
      16,
      1,
      "node C:/Repos/Skill Workshop/rag-interface/scripts/smoke/runners/buttons.mjs",
    ),
    repoRoot,
  ),
  true,
...
assert.equal(
  isProjectOwnedProcess(
    processInfo(
      23,
      1,
      "node C:/Repos/Skill Workshop/rag-interface-backup/scripts/smoke/runners/buttons.mjs",
    ),
    repoRoot,
  ),
  false,
...
assert.equal(
  isProjectOwnedProcess(
    processInfo(
      24,
      1,
      "node C:/Repos/Skill Workshop/archive-C:/Repos/Skill Workshop/rag-interface/scripts/smoke/runners/buttons.mjs",
    ),
    repoRoot,
  ),
  false,
...
assert.equal(
  isProjectOwnedProcess(
    processInfo(
      17,
      1,
      "node C:/Repos/Skill Workshop/rag-interface/scripts/qa/manual-external.mjs --start-server",
    ),
    repoRoot,
  ),
  true,
...
const plan = buildProjectCleanupPlan(
  [
    processInfo(
      20,
      1,
      "node C:/Repos/Skill Workshop/rag-interface/scripts/smoke/runners/production.mjs",
    ),
    processInfo(
      21,
      20,
