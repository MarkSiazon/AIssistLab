...
This is a Claude Code **skill development workspace**. Skills are markdown prompt files stored in `.claude/skills/` that are invoked via `/skill-name` slash commands inside Claude Code sessions.
