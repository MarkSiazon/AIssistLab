...
Write the PR description (Step 4 content only — not the hygiene report or changelog) to `pr-description.md` in the repository root. Then tell the user:
...
To open an interactive PR form with the body pre-filled:
  gh pr create --body-file pr-description.md --web
```
